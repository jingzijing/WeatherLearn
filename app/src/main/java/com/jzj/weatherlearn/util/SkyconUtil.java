	...
	public static Drawable handlerWeatherIcno(String skyconVal)
	{
		...
		switch (skyconVal)
		{
			...
			case SkyconUtil.PARTLY_CLOUDY_NIGHT:
				drawable = App.context.getResources()
						.getDrawable(R.drawable.ic_partly_cloudy_day, null);
				break;
			//阴天
			...
			case SkyconUtil.MODERATE_RAIN:
				drawable = App.context.getResources()
						.getDrawable(R.drawable.ic_moderate_rain, null);
				break;
			...
			case SkyconUtil.MODERATE_SNOW:
				drawable = App.context.getResources()
						.getDrawable(R.drawable.ic_moderate_snow, null);
				break;
			...
			case SkyconUtil.SAND:
				drawable = App.context.getResources()
						.getDrawable(R.drawable.ic_dust_with_wind, null);
				break;
			//风
